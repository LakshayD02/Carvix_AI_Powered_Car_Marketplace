// app/page.js
import { ChevronRight, Car, Calendar, Shield, CheckCircle2, Star } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-5xl mx-auto">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Search Your Car</h3>
              <p className="text-gray-600">Use our AI image search or advanced filters to find the perfect vehicle matching your needs.</p>
            </div>
            <div className="flex flex-col items-center relative">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Book Test Drive</h3>
              <p className="text-gray-600">Schedule a test drive at your convenience with our real-time availability calendar.</p>
            </div>
            <div className="flex flex-col items-center relative">
              <div className="hidden md:block absolute top-8 -left-1/2 w-full h-0.5 bg-gray-200 -z-10"></div>
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Finalize Purchase</h3>
              <p className="text-gray-600">Complete your paperwork securely and drive away in your new dream car.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              { name: "Sarah Jenkins", role: "First-time Buyer", quote: "The AI image search is incredible! I snapped a picture of a car I liked on the street, and Carvix found the exact model in my area." },
              { name: "Michael Chang", role: "Car Enthusiast", quote: "Booking a test drive was so seamless. No phone calls, no waiting around. The dealership was ready when I arrived." },
              { name: "Emily Rodriguez", role: "Family Car Upgrader", quote: "The detailed specifications and transparent pricing helped me make the right choice for my growing family. Highly recommended!" }
            ].map((testimonial, i) => (
